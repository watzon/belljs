import { MessageContainer } from "../tl/core/mod.ts";
import { TLMessage } from "../tl/core/mod.ts";
import { BinaryWriter } from "./BinaryWriter.ts";
import type { MTProtoState } from "../network/MTProtoState.ts";
import type { RequestState } from "../network/RequestState.ts";
