...
export namespace Api {
  ...
  export class MessageActionAttachMenuBotAllowed extends VirtualClass<void> {
    CONSTRUCTOR_ID: 3890700183;
    SUBCLASS_OF_ID: 2256589094;
    classType: "constructor";
    className: "MessageActionAttachMenuBotAllowed";
    static fromReader(reader: Reader): MessageActionAttachMenuBotAllowed;
  }
  ...
  export class InputStickerSetEmojiGenericAnimations
    extends VirtualClass<void> {
  ...
  export class InputStickerSetEmojiDefaultTopicIcons
    extends VirtualClass<void> {
  ...
  export class EmojiStatusUntil extends VirtualClass<{
    ...
    CONSTRUCTOR_ID: 4197492935;
    SUBCLASS_OF_ID: 4180717880;
    classType: "constructor";
    className: "EmojiStatusUntil";
    static fromReader(reader: Reader): EmojiStatusUntil;
    documentId: long;
    until: int;
  }
  ...
  export namespace account {
    ...
    export class GetAutoSaveSettings extends Request<
      void,
      account.TypeAutoSaveSettings
    > {
  ...
  export namespace messages {
    ...
    export class SendBotRequestedPeer extends Request<
      Partial<{
        ...
        msgId: MessageIDLike;
        buttonId: int;
        requestedPeer: Api.TypeEntityLike;
      }>,
      Api.TypeUpdates
    > {
      CONSTRUCTOR_ID: 4265136155;
      SUBCLASS_OF_ID: 2331323052;
      classType: "request";
