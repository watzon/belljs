import * as bigInt from "npm:big-integer";
...
import tlContent from "./apiTl.js";
import schemeContent from "./schemaTl.js";

function generateRandomBigInt() {
  return readBigIntFromBuffer(generateRandomBytes(8), false, true);
}

import { parseTl, serializeBytes, serializeDate } from "./generationHelpers.ts";
...
const CACHING_SUPPORTED = typeof self !== "undefined" &&
...
export const Api = buildApiFromTlSchema();
