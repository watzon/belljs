...
import { DownloadMediaInterface, IterDownloadFunction } from "./downloads.ts";
import { NewMessage, NewMessageEvent } from "../events/mod.ts";
...
import { CallbackQuery, CallbackQueryEvent } from "../events/CallbackQuery.ts";
import { EditedMessage, EditedMessageEvent } from "../events/EditedMessage.ts";
import {
  DeletedMessage,
  DeletedMessageEvent,
} from "../events/DeletedMessage.ts";
...
export class TelegramClient extends TelegramBaseClient {
  ...
  /**
     ...
     * @example
     * ```ts
     * import {Button} from "telegram.ts";
